...
const Accounts = () => {
    ...
    const inputBoxStyle = "rounded-lg mt-2 w-full focus:scale-105 text-lg h-10 transition-all duration-300 text-center p-2 font-semibold";
            ...
            {select===null &&
                <div>
                    ...
                    <div className='p-3 py-10 grid place-items-center'>
                        <p className='text-center font-bold text-5xl text-[#4C585B] py-10'>Need to open an Account?</p>
                    ...
                    <div className='bg-[#4C585B] text-white rounded-lg p-5 gap-4 hover:scale-105 shadow-lg hover:shadow-xl transition-all duration-300'>
                        ...
                        {!submitted &&
                            <div>
                                ...
                                <input type="number" className={inputBoxStyle} placeholder='Password'/>
                                <br />
                                <div className='flex justify-center items-center py-5'>
